...
isDeprecated: true
deprecatedBy: upload_session/append_2
urlStructure: https://content.dropbox.com/2/files/upload_session/append
...
authentication:
  - user
  - team_admin
shellExample: 'curl -X POST https://content.dropboxapi.com/2/files/upload_session/append \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Dropbox-API-Arg: {\"session_id\": \"1234faaf0678bcde\",\"offset\": 0}" \\n    --header "Content-Type: application/octet-stream" \\n    --data-binary @local_file.txt'
paramType: 
  namespace: files
