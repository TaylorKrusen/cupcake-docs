...
isDeprecated: true
deprecatedBy: delete_2
urlStructure: https://api.dropbox.com/2/files/delete
endpointFormat: rpc
isPreview: false
...
authentication:
  - user
  - team_admin
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/delete \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"path\": \"/Homework/math/Prime_Numbers.txt\"}"'
paramType: 
  namespace: files
  datatype: DeleteArg
paramExamples: 
...
import stoneTypes from '../../type-lookup/files-delete.js'
