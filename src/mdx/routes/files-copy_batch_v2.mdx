...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/files/copy_batch_v2
endpointFormat: rpc
isPreview: false
...
authentication:
  - user
  - team_admin
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/copy_batch_v2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"entries\": [{\"from_path\": \"/Homework/math\",\"to_path\": \"/Homework/algebra\"}],\"autorename\": false}"'
paramType: 
  namespace: files
  datatype: RelocationBatchArgBase
paramExamples: 
  - label: default
    content: {"entries": [{"from_path": "/Homework/math","to_path": "/Homework/algebra"}],"autorename": false}
returnType: 
  namespace: files
...
import stoneTypes from '../../type-lookup/files-copy_batch_v2.js'
