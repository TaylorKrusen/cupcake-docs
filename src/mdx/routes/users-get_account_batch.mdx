...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/users/get_account_batch
endpointFormat: rpc
isPreview: false
scope: sharing.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/users/get_account_batch \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"account_ids\": [\"dbid:AAH4f99T0taONIb-OurWxbNQ6ywGRopQngc\",\"dbid:AAH1Vcz-DVoRDeixtr_OA8oUGgiqhs4XPOQ\"]}"'
paramType: 
  namespace: users
  datatype: GetAccountBatchArg
paramExamples: 
  - label: default
    content: {"account_ids": ["dbid:AAH4f99T0taONIb-OurWxbNQ6ywGRopQngc","dbid:AAH1Vcz-DVoRDeixtr_OA8oUGgiqhs4XPOQ"]}
returnType: 
  namespace: users
...
errorType: 
  namespace: users
  datatype: GetAccountBatchError
errorExamples: 
  - label: default
    content: {"error_summary": "no_account/...","error": {".tag": "no_account","no_account": "dbid:AAH4f99T0taONIb-OurWxbNQ6ywGRopQngc"}}
  - label: default
    content: {".tag": "no_account", "no_account": "dbid:AAH4f99T0taONIb-OurWxbNQ6ywGRopQngc"}
  - label: other
...
import stoneTypes from '../../type-lookup/users-get_account_batch.js'
