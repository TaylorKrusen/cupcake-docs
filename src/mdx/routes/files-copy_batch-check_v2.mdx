---
name: /copy_batch/check_2
route: /files/copy_batch/check_v2
namespace: files
version: 2
menu: files
description: Returns the status of an asynchronous job for `copy_batch:2`. It returns list of results for each entry.
isDeprecated: false
urlStructure: https://api.dropbox.com/2/files/copy_batch/check_v2
endpointFormat: rpc
isPreview: false
...
authentication:
  - user
  - team_admin
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/copy_batch/check_v2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"async_job_id\": \"34g93hh34h04y384084\"}"'
paramType: 
  namespace: async
  datatype: PollArg
paramExamples: 
...
import stoneTypes from '../../type-lookup/files-copy_batch-check_v2.js'
