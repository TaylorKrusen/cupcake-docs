...
authentication:
  - user
  - team_admin
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/move_batch_v2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"entries\": [{\"from_path\": \"/Homework/math\",\"to_path\": \"/Homework/algebra\"}],\"autorename\": false,\"allow_ownership_transfer\": false}"'
paramType: 
  namespace: files
  datatype: MoveBatchArg
paramExamples: 
  - label: default
    content: {"entries": [{"from_path": "/Homework/math","to_path": "/Homework/algebra"}],"autorename": false,"allow_ownership_transfer": false}
returnType: 
  namespace: files
  datatype: RelocationBatchV2Launch
returnExamples: 
  - label: complete
...
import stoneTypes from '../../type-lookup/files-move_batch_v2.js'
