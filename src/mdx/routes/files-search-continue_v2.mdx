---
name: /search/continue_2
route: /files/search/continue_v2
namespace: files
version: 2
menu: files
...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/files/search/continue_v2
endpointFormat: rpc
isPreview: false
scope: files.metadata.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/search/continue_v2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"cursor\": \"ZtkX9_EHj3x7PMkVuFIhwKYXEpwpLwyxp9vMKomUhllil9q7eWiAu\"}"'
paramType: 
  namespace: files
  datatype: SearchV2ContinueArg
paramExamples: 
  - label: default
...
import stoneTypes from '../../type-lookup/files-search-continue_v2.js'
