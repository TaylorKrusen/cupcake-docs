...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/files/search/continue_2
endpointFormat: rpc
isPreview: false
scope: files.metadata.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/search/continue_2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"cursor\": \"ZtkX9_EHj3x7PMkVuFIhwKYXEpwpLwyxp9vMKomUhllil9q7eWiAu\"}"'
paramType: 
  namespace: files
