...
errorType: 
  namespace: team_log
  datatype: GetTeamEventsError
errorExamples: 
  - label: default
    content: {"error_summary": "account_id_not_found/...","error": {".tag": "account_id_not_found"}}
  - label: default
    content: {".tag": "account_id_not_found"}
  - label: account_id_not_found
    content: {"error_summary": "account_id_not_found/...","error": {".tag": "account_id_not_found"}}
  - label: account_id_not_found
    content: {".tag": "account_id_not_found"}
  - label: invalid_time_range
    content: {"error_summary": "invalid_time_range/...","error": {".tag": "invalid_time_range"}}
  - label: invalid_time_range
    content: {".tag": "invalid_time_range"}
  - label: invalid_filters
    content: {"error_summary": "invalid_filters/...","error": {".tag": "invalid_filters"}}
  - label: invalid_filters
    content: {".tag": "invalid_filters"}
  - label: other
...
import stoneTypes from '../../type-lookup/team_log-get_events.js'
