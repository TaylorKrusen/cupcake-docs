...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/file_requests/list_2
endpointFormat: rpc
isPreview: true
scope: file_requests.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/file_requests/list_2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"limit\": 1000}"'
paramType: 
  namespace: file_requests
