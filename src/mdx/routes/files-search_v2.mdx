...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/files/search_v2
endpointFormat: rpc
isPreview: false
scope: files.metadata.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/search_v2 \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"query\": \"cat\",\"include_highlights\": false}"'
paramType: 
  namespace: files
...
import stoneTypes from '../../type-lookup/files-search_v2.js'
