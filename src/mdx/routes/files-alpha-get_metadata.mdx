...
route: /files/alpha/get_metadata
namespace: files
version: 1
menu: deprecated
...
isDeprecated: true
deprecatedBy: get_metadata
urlStructure: https://api.dropbox.com/2/files/alpha/get_metadata
endpointFormat: rpc
isPreview: true
scope: None
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/files/alpha/get_metadata \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"path\": \"/Homework/math\",\"include_media_info\": false,\"include_deleted\": false,\"include_has_explicit_shared_members\": false}"'
paramType: 
  namespace: files
  datatype: AlphaGetMetadataArg
paramExamples: 
  - label: default
...
errorType: 
  namespace: files
  datatype: AlphaGetMetadataError
errorExamples: 
---

import Endpoint from '../../components/Endpoint'
import stoneTypes from '../../type-lookup/files-alpha-get_metadata.js'
