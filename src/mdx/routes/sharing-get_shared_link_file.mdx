...
isDeprecated: false
urlStructure: https://content.dropbox.com/2/sharing/get_shared_link_file
endpointFormat: download
isPreview: false
scope: sharing.read
authentication:
  - user
shellExample: 'curl -X POST https://content.dropboxapi.com/2/sharing/get_shared_link_file \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Dropbox-API-Arg: {\"url\": \"https://www.dropbox.com/s/2sn712vy1ovegw8/Prime_Numbers.txt?dl=0\",\"path\": \"/Prime_Numbers.txt\"}"'
paramType: 
  namespace: sharing
