...
isDeprecated: false
urlStructure: https://api.dropbox.com/2/sharing/list_mountable_folders
endpointFormat: rpc
isPreview: false
scope: sharing.read
authentication:
  - user
shellExample: 'curl -X POST https://api.dropboxapi.com/2/sharing/list_mountable_folders \\n    --header "Authorization: Bearer YOUR_ACCESS_TOKEN" \\n    --header "Content-Type: application/json" \\n    --data "{\"limit\": 100,\"actions\": []}"'
paramType: 
  namespace: sharing
...
import stoneTypes from '../../type-lookup/sharing-list_mountable_folders.js'
