export default {
    ...
    "files": {
        ...
        "UploadErrorWithProperties": {
            "fields": [
                {
                    "description": "Unable to save the uploaded contents to a file.",
                    "parameter": "path",
                    "type": {
                        "datatype": "UploadWriteFailed",
                        "namespace": "files"
                    }
                },
                {
        ...
        "UploadWriteFailed": {
            "fields": [
                {
                    "description": "The reason why the file couldn't be saved.",
                    "parameter": "reason",
                    "type": {
                        "datatype": "WriteError",
                        "namespace": "files"
