export default {
    "sharing": {
        ...
        "LinkExpiry": {
            "fields": [
                {
                    "description": "Remove the currently set expiry for the link.",
                    "parameter": "remove_expiry",
                    "type": {
                        "primitive": "Void"
                    }
        ...
        "LinkPassword": {
            "fields": [
                {
                    "description": "Remove the currently set password for the link.",
                    "parameter": "remove_password",
                    "type": {
                        "primitive": "Void"
                    }
        ...
        "LinkSettings": {
            ...
            "fields": [
                ...
                {
                    "description": "The type of audience on the link for this file.",
                    "parameter": "audience",
                    "type": {
                        "optional": {
                            "datatype": "LinkAudience",
                ...
                {
                    "description": "An expiry timestamp to set on a link.",
                    "parameter": "expiry",
                    "type": {
                        "optional": {
                            "datatype": "LinkExpiry",
        ...
        "ShareFolderArg": {
            "fields": [
                ...
                {
                    "description": "Who can add and remove members of this shared folder.",
                    "parameter": "acl_update_policy",
                    "type": {
                        "optional": {
                            "datatype": "AclUpdatePolicy",
                ...
                {
                    "description": "Who can be a member of this shared folder. Only applicable if the current user is on a team.",
                    "parameter": "member_policy",
                    "type": {
                        "optional": {
                            "datatype": "MemberPolicy",
                ...
                {
                    "description": "The policy to apply to shared links created for content inside this shared folder.  The current user must be on a team to set this policy to :field:`SharedLinkPolicy.members`.",
                    "parameter": "shared_link_policy",
                    "type": {
                        "optional": {
                            "datatype": "SharedLinkPolicy",
                ...
                {
                    "description": "The access inheritance settings for the folder.",
                ...
                },
                {
                    ...
                    "parameter": "link_settings",
                    "type": {
                        "optional": {
                            "datatype": "LinkSettings",
                            "namespace": "sharing"
                        }
                    }
                }
        ...
        "ShareFolderError": {
            "fields": [
                ...
                {
                    "description": ":field:`ShareFolderArg.path` is invalid.",
                    "parameter": "bad_path",
                    "type": {
                        "datatype": "SharePathError",
                        "namespace": "sharing"
                    }
                },
                {
                    "description": "Team policy is more restrictive than :field:`ShareFolderArg.member_policy`.",
                    "parameter": "team_policy_disallows_member_policy",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "The current user's account is not allowed to select the specified :field:`ShareFolderArg.shared_link_policy`.",
                    "parameter": "disallowed_shared_link_policy",
                    "type": {
                        "primitive": "Void"
                    }
                },
        ...
        "SharePathError": {
            "fields": [
                {
                    "description": "A file is at the specified path.",
                    "parameter": "is_file",
                    "type": {
                        "primitive": "Void"
                    }
                ...
                {
                    "description": "We do not support sharing a folder inside a shared folder.",
                    "parameter": "inside_shared_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support shared folders that contain shared folders.",
                    "parameter": "contains_shared_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support shared folders that contain app folders.",
                    "parameter": "contains_app_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support shared folders that contain team folders.",
                    "parameter": "contains_team_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support sharing an app folder.",
                ...
                {
                    "description": "We do not support sharing a folder inside an app folder.",
                    "parameter": "inside_app_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "A public folder can't be shared this way. Use a public link instead.",
                    "parameter": "is_public_folder",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "A folder inside a public folder can't be shared this way. Use a public link instead.",
                ...
                {
                    "description": "Folder is already shared. Contains metadata about the existing shared folder.",
                    "parameter": "already_shared",
                    "type": {
                        "datatype": "SharedFolderMetadata",
                        "namespace": "sharing"
                    }
                },
                {
                    ...
                    "parameter": "invalid_path",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support sharing a Mac OS X package.",
                    "parameter": "is_osx_package",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "We do not support sharing a folder inside a Mac OS X package.",
                ...
                {
                    "description": "We do not support sharing the Vault folder.",
                    "parameter": "is_vault",
                    "type": {
                        "primitive": "Void"
                    }
