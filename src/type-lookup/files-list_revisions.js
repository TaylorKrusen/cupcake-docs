export default {
    ...
    "files": {
        ...
        "ListRevisionsMode": {
            "fields": [
                {
                    "description": "Returns revisions with the same file path as identified by the latest file entry at the given file path or id.",
                    "parameter": "path",
                    "type": {
                        "primitive": "Void"
                    }
                ...
                {
                    "description": "Returns revisions with the same file id as identified by the latest file entry at the given file path or id.",
                    "parameter": "id",
                    "type": {
                        "primitive": "Void"
                    }
