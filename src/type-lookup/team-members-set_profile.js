    ...
    "team": {
        ...
        "MembersSetProfileArg": {
            ...
            "fields": [
                ...
                },
                {
                    ...
                    "parameter": "new_is_directory_restricted",
                    "type": {
                        "optional": {
                            "primitive": "Boolean"
                        }
        ...
        "MembersSetProfileError": {
            "fields": [
                ...
                {
                    "description": "It is unsafe to use both external_id and new_external_id.",
                    "parameter": "external_id_and_new_external_id_unsafe",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "None of new_email, new_given_name, new_surname, or new_external_id are specified.",
                    "parameter": "no_new_data_specified",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Email is already reserved for another user.",
                    "parameter": "email_reserved_for_other_user",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "The external ID is already in use by another team member.",
                    "parameter": "external_id_used_by_other_user",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Modifying deleted users is not allowed.",
                    "parameter": "set_profile_disallowed",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Parameter new_email cannot be empty.",
                    "parameter": "param_cannot_be_empty",
                    "type": {
                        "primitive": "Void"
                    }
                },
                ...
                {
                    "description": "The persistent ID is already in use by another team member.",
                    "parameter": "persistent_id_used_by_other_user",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Directory Restrictions option is not available.",
                    "parameter": "directory_restricted_off",
                    "type": {
                        "primitive": "Void"
                    }
                },
