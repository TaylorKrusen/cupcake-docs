export default {
    ...
    "files": {
        "CreateFolderBatchError": {
            "fields": [
                {
                    "description": "The operation would involve too many files or folders.",
        ...
        "CreateFolderBatchJobStatus": {
            "fields": [
                ...
                {
                    "description": "The batch create folder has finished.",
                    "parameter": "complete",
                    "type": {
                        "datatype": "CreateFolderBatchResult",
                        "namespace": "files"
                    }
                },
                {
                    "description": "The batch create folder has failed.",
                    "parameter": "failed",
                    "type": {
                        "datatype": "CreateFolderBatchError",
                        "namespace": "files"
                    }
                },
                {
        ...
        "CreateFolderBatchResult": {
            "fields": [
                {
                    "description": "Each entry in :field:`CreateFolderBatchArg.paths` will appear at the same position inside :field:`CreateFolderBatchResult.entries`.",
                    "parameter": "entries",
                    "type": {
                        "list": {
                            "datatype": "CreateFolderBatchResultEntry",
                            "namespace": "files"
                        }
                    }
                }
            ...
            "fields": [
                {
                    "parameter": "success",
                    "type": {
                        "datatype": "CreateFolderEntryResult",
                        "namespace": "files"
                    }
                },
                {
                    "parameter": "failure",
                    "type": {
                        "datatype": "CreateFolderEntryError",
                        "namespace": "files"
                    }
                }
            ],
