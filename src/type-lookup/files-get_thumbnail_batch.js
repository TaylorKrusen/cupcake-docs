export default {
    ...
    "files": {
        ...
        "GetThumbnailBatchError": {
            "fields": [
                {
                    "description": "The operation involves more than 25 files.",
            ...
            "fields": [
                {
                    ...
                    "type": {
                        "list": {
                            "datatype": "GetThumbnailBatchResultEntry",
                            "namespace": "files"
                        }
                    }
                }
        ...
        "GetThumbnailBatchResultData": {
            "fields": [
                ...
                {
                    "description": "A string containing the base64-encoded thumbnail data for this file.",
                    "parameter": "thumbnail",
                    "type": {
                        "primitive": "String"
                    }
            ...
            "fields": [
                {
                    "parameter": "success",
                    "type": {
                        "datatype": "GetThumbnailBatchResultData",
                        "namespace": "files"
                    }
                },
                {
                    "description": "The result for this file if it was an error.",
                    "parameter": "failure",
                    "type": {
