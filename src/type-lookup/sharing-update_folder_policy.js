    ...
    "sharing": {
        ...
        "UpdateFolderPolicyError": {
            "fields": [
                ...
                {
                    "description": ":field:`UpdateFolderPolicyArg.member_policy` was set even though user is not on a team.",
                    "parameter": "not_on_team",
                    "type": {
                        "primitive": "Void"
                    }
                },
                ...
                {
                    "description": "The current account is not allowed to select the specified :field:`ShareFolderArg.shared_link_policy`.",
