    ...
    "files": {
        ...
        "GetTemporaryLinkError": {
            "fields": [
                ...
                {
                    "description": "The user's email address needs to be verified to use this functionality.",
                ...
                {
                    "description": "Cannot get temporary link to this file type; use :route:`export` instead.",
                    "parameter": "unsupported_file",
                    "type": {
                        "primitive": "Void"
                    }
                },
