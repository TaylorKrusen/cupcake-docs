export default {
    "team": {
        ...
        "ListTeamAppsError": {
            ...
            "fields": [
                {
                    "description": "Indicates that the cursor has been invalidated. Call :route:`linked_apps/list_team_linked_apps` again with an empty cursor to obtain a new cursor.",
                    "parameter": "reset",
                    "type": {
                        "primitive": "Void"
                    }
