    ...
    "files": {
        ...
        "ExportError": {
            "fields": [
                ...
                {
                    "description": "This file type cannot be exported. Use :route:`download` instead.",
                    "parameter": "non_exportable",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "The exportable content is not yet available. Please retry later.",
                    "parameter": "retry_error",
                    "type": {
                        "primitive": "Void"
                    }
                },
        ...
        "ExportMetadata": {
            "fields": [
                ...
                {
                    "description": "A hash based on the exported file content. This field can be used to verify data integrity. Similar to content hash. For more information see our :link:`Content hash https://www.dropbox.com/developers/reference/content-hash` page.",
                    "parameter": "export_hash",
                    "type": {
                        "optional": {
                            "primitive": "String"
                        }
        ...
        "ExportResult": {
            "fields": [
                {
                    "description": "Metadata for the exported version of the file.",
                    "parameter": "export_metadata",
                    "type": {
                        "datatype": "ExportMetadata",
                        "namespace": "files"
                    }
                },
                {
