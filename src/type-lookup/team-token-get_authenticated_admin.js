export default {
    ...
    "team": {
        ...
        "TokenGetAuthenticatedAdminError": {
            ...
            "fields": [
                {
                    "description": "The current token is not associated with a team admin, because mappings were not recorded when the token was created. Consider re-authorizing a new access token to record its authenticating admin.",
                    "parameter": "mapping_not_found",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Either the team admin that authorized this token is no longer an active member of the team or no longer a team admin.",
                    "parameter": "admin_not_active",
                    "type": {
                        "primitive": "Void"
                    }
                },
        ...
        "TokenGetAuthenticatedAdminResult": {
            ...
            "fields": [
                {
                    "description": "The admin who authorized the token.",
                    "parameter": "admin_profile",
                    "type": {
