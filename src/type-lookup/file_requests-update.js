    ...
    "file_requests": {
        ...
        "UpdateFileRequestArgs": {
            ...
            "fields": [
                ...
                {
                    "description": "The new deadline for the file request. Deadlines can only be set by Professional and Business accounts.",
                    "parameter": "deadline",
                    "type": {
                        "datatype": "UpdateFileRequestDeadline",
                        "namespace": "file_requests"
                    }
                },
                {
        ...
        "UpdateFileRequestDeadline": {
            "fields": [
                {
                    "description": "Do not change the file request's deadline.",
                    "parameter": "no_update",
                    "type": {
                        "primitive": "Void"
                    }
                ...
                {
                    "description": "If :val:`null`, the file request's deadline is cleared.",
                    "parameter": "update",
                    "type": {
                        "optional": {
                            "datatype": "FileRequestDeadline",
