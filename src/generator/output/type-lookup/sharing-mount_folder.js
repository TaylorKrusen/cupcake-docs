    ...
    "sharing": {
        ...
        "MountFolderError": {
            "fields": [
                ...
                {
                    "description": "Mounting would cause a shared folder to be inside another, which is disallowed.",
                ...
                {
                    "description": "The current user does not have enough space to mount the shared folder.",
                    "parameter": "insufficient_quota",
                    "type": {
                        "datatype": "InsufficientQuotaAmounts",
                        "namespace": "sharing"
                    }
                },
                {
                    "description": "The shared folder is already mounted.",
                    "parameter": "already_mounted",
                    "type": {
                        "primitive": "Void"
                    }
                },
                ...
                {
                    "description": "The shared folder is not mountable. One example where this can occur is when the shared folder belongs within a team folder in the user's Dropbox.",
                    "parameter": "not_mountable",
                    "type": {
                        "primitive": "Void"
                    }
                },
