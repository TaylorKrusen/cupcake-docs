export default {
    ...
    "team_log": {
        ...
        "GetTeamEventsArg": {
            "fields": [
                {
                    "description": "The maximal number of results to return per call. Note that some calls may not return :field:`limit` number of events, and may even return no events, even with `has_more` set to true. In this case, callers should fetch again using :route:`get_events/continue`.",
                    "parameter": "limit",
                    "type": {
                        "primitive": "UInt32"
                    }
                ...
                {
                    "description": "Filter the events by account ID. Return only events with this account_id as either Actor, Context, or Participants.",
                ...
                {
                    "description": "Filter the returned events to a single category. Note that category shouldn't be provided together with event_type.",
                    "parameter": "category",
                    "type": {
                        "optional": {
                ...
                {
                    "description": "Filter the returned events to a single event type. Note that event_type shouldn't be provided together with category.",
                    "parameter": "event_type",
                    "type": {
                        "optional": {
                            "datatype": "EventTypeArg",
                            "namespace": "team_log"
                        }
                    }
                }
        ...
        "GetTeamEventsError": {
            ...
            "fields": [
                {
                    "description": "No user found matching the provided account_id.",
                    "parameter": "account_id_not_found",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    ...
                    "parameter": "invalid_time_range",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "Invalid filters. Do not specify both event_type and category parameters for the same call.",
                    "parameter": "invalid_filters",
                    "type": {
                        "primitive": "Void"
                    }
                },
