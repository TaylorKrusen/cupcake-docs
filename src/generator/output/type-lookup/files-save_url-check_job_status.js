    ...
    "files": {
        ...
        "SaveUrlError": {
            "fields": [
                ...
                {
                    "description": "Failed downloading the given URL. The URL may be  password-protected and the password provided was incorrect,  or the link may be disabled.",
                    "parameter": "download_failed",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "The given URL is invalid.",
                    "parameter": "invalid_url",
                    "type": {
                        "primitive": "Void"
                    }
                },
                {
                    "description": "The file where the URL is saved to no longer exists.",
                    "parameter": "not_found",
                    "type": {
                        "primitive": "Void"
                    }
        ...
        "SaveUrlJobStatus": {
            "fields": [
                ...
                {
                    "description": "Metadata of the file where the URL is saved to.",
                    "parameter": "complete",
                    "type": {
