    ...
    "sharing": {
        ...
        "ListFileMembersBatchResult": {
            ...
            "fields": [
                ...
                {
                    "description": "The result for this particular file.",
                    "parameter": "result",
                    "type": {
                        "datatype": "ListFileMembersIndividualResult",
                        "namespace": "sharing"
                    }
                }
            ],
        ...
        "ListFileMembersCountResult": {
            "fields": [
                {
                    "description": "A list of members on this file.",
                    "parameter": "members",
                    "type": {
        ...
        "ListFileMembersIndividualResult": {
            "fields": [
                {
                    "description": "The results of the query for this file if it was successful.",
                    "parameter": "result",
                    "type": {
                        "datatype": "ListFileMembersCountResult",
                        "namespace": "sharing"
                    }
                },
                {
                    "description": "The result of the query for this file if it was an error.",
